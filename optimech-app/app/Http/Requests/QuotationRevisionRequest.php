...
class QuotationRevisionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'quotation_products.*.add_spec' => ['nullable', 'string', 'max:1000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'quotation_revision.currency.in' => 'Please select a valid currency (USD, EUR, BDT, RMB, INR).',
            ...
            // Products messages
            'quotation_products.required' => 'Please add at least one product to the revision.',
            'quotation_products.min' => 'Please add at least one product to the revision.',
