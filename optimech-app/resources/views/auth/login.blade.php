...
<head>
    ...
    <style>
        ...
        /* Make sure the layout sits above background effects */
        main, .flex, .w-full {
            position: relative;
            z-index: 10;
        }
...
<body class="grid place-items-center min-h-screen dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <div class="flex items-center justify-center">
                            <div class="text-center">
                                ...
                                <h1 class="text-3xl font-sans drop-shadow-md font-bold text-white text-left pl-10 leading-tight">
                                    Quotation & Invoice<br>Management System
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="{{ route('signIn') }}" method="POST">
                                ...
                                <div>
                                    <label for="username"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your User ID</label>
    ...
    <footer class="absolute bottom-0 left-0 right-0 z-20 py-4">
        <div class="text-center">
            <p class="text-sm text-gray-900">© {{ date('Y') }} probaho dynamics all rights reserved</p>
        </div>
    </footer>
</body>
