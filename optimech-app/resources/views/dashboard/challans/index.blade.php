                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-center gap-1">
                                    @php
                                        ...
                                        $billUrl = $hasAdvance
                                            ? route('bills.create', ['quotation_id' => $quotation->id, 'parent_bill_id' => $latestAdvance->id])
                                            : route('bills.create', ['quotation_id' => $quotation->id]);
                                        ...
                                        $dropdownData = [
                                            ...
                                            'continueChallanUrl' => route('challans.create', ['quotation_id' => $item->revision->quotation->id]),
                                            'billUrl' => $billUrl,
                                            'billLabel' => $billLabel,
                                            'viewUrl' => route('challans.show', $item->id),
                                            'editUrl' => route('challans.edit', $item->id),
                                            'deleteUrl' => route('challans.destroy', $item->id),
