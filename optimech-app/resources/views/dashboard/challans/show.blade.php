<x-dashboard.layout.default :title="'Challan - ' . $challan->challan_no">
    <style>
        ...
        #q-invoice {
            ...
            border-radius: 8px;
            overflow: hidden;
            box-shadow: 0 6px 18px rgba(11, 78, 163, 0.06);
        }
    ...
    <x-dashboard.ui.bread-crumb>
        <li class="inline-flex items-center">
            <a href="{{ route('challans.index') }}" class="inline-flex items-center text-sm font-medium text-gray-300">
            ...
            <div id="q-invoice">
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-4">
                        <div class="border col-span-2 border-gray-200 rounded-lg p-4 bg-gray-50 grid grid-cols-2">
                            <div>
