<x-dashboard.layout.default title="Edit Product">
    ...
    <div x-data="productEditForm()" x-init="init()" class="space-y-6">
        <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-8" novalidate
                            ...
                            <template x-if="!product.imageUrl">
                                <div
                                    ...
                                    <svg class="w-10 h-10 mb-2 text-gray-400 transition-transform duration-300"
                                        :class="{ 'scale-125': imageHovered }" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="border-t-2 border-dashed border-gray-300 dark:border-gray-600 pt-4">
                                <div class="flex items-center justify-between mb-4">
                                    <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Or upload a new
                                        one:</h4>
