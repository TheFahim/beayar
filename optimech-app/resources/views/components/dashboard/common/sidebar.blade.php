...
<x-dashboard.common.sidebar-wrapper>
    <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="sidebar-dropdown-1" class="hidden py-2 space-y-2 transition duration-300">
                    ...
                    @role('dev')
                        ...
                        <li>
                            <x-dashboard.common.sidebar-link url="{{ route('permissions.index') }}" class="pl-12">
        ...
        @role('admin')
            <li>
                <x-dashboard.common.sidebar-link url="{{ route('users.index') }}">
        ...
        <li>
            ...
            <ul id="sidebar-dropdown-1" class="hidden py-2 space-y-2 transition duration-300">
                <li>
                    <x-dashboard.common.sidebar-link url="{{ route('images.index') }}" class="pl-12">
                        <span class="flex-1 ms-3 whitespace-nowrap">Images</span>
                    </x-dashboard.common.sidebar-link>

                </li>
                <li>
                    <x-dashboard.common.sidebar-link url="{{ route('products.index') }}" class="pl-12">
                        <span class="flex-1 ms-3 whitespace-nowrap">Products</span>
                    </x-dashboard.common.sidebar-link>
                </li>
                {{-- <li>
                    <x-dashboard.common.sidebar-link url="{{ route('specifications.index') }}" class="pl-12">
                        <span class="flex-1 ms-3 whitespace-nowrap">Specifications</span>
                    </x-dashboard.common.sidebar-link>
                </li> --}}
