<x-layouts.guest>
    <x-slot:title>Login - Beayar ERP</x-slot:title>

    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6">
        <h1 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Sign in</h1>
        ...
        <form class="space-y-4" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('password.request') }}" class="text-sm text-primary-600 dark:text-primary-500 hover:underline">Forgot password?</a>
            </div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 text-center">
                Don't have an account? <a href="{{ route('register') }}" class="text-primary-600 dark:text-primary-500 hover:underline">Sign up</a>
            </p>
        </form>
    </div>
</x-layouts.guest>
