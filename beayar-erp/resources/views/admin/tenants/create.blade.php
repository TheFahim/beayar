<x-admin.layout.default title="Create Tenant">
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.tenants.index') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Tenants</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Create New Tenant</h1>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('admin.tenants.store') }}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Company Information</h2>
                    ...
                    <div class="sm:col-span-2">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white mb-2 mt-4">Owner Information</h2>
                        <hr class="mb-4 border-gray-200 dark:border-gray-700">
                    </div>

                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Owner Name</label>
                    ...
                    <div class="sm:col-span-2">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white mb-2 mt-4">Subscription</h2>
                        <hr class="mb-4 border-gray-200 dark:border-gray-700">
                    </div>
                    
                    <div class="sm:col-span-2">
                        <label for="plan_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Plan</label>
                        <select id="plan_id" name="plan_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            @foreach($plans as $plan)
                                <option value="{{ $plan->id }}">{{ $plan->name }} ({{ number_format($plan->base_price, 2) }}/{{ $plan->billing_cycle }})</option>
                            @endforeach
                        </select>
                    </div>
                </div>
