  ...
  <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
      ...
      <div class="pricing-card rounded-2xl p-7 flex flex-col">
        ...
        <a href="/plan-selection?plan=pro" class="btn-outline text-center text-sm font-semibold text-slate-300 py-3 rounded-xl">Get Pro</a>
      </div>
      ...
      <div class="pricing-card pricing-featured rounded-2xl p-7 flex flex-col relative lg:-mt-4 lg:-mb-4">
        ...
        <a href="/plan-selection?plan=pro-plus" class="btn-primary text-center text-sm font-semibold text-white py-3 rounded-xl">Get Pro Plus</a>
      </div>
