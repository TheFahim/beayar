                ...
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('onboarding.plan') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-900 md:ml-2 dark:text-white">Create New</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create New Workspace</h1>
                <p class="mt-2 text-lg text-gray-500 dark:text-gray-400">Set up a new company environment to manage your business operations.</p>
            </div>

            <!-- Form Card -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <form action="{{ route('onboarding.company.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="flex items-center gap-6">
                                <div class="shrink-0 relative group">
                                    <div class="h-24 w-24 rounded-2xl overflow-hidden ring-1 ring-gray-200 dark:ring-gray-700 bg-gray-50 dark:bg-gray-700 flex items-center justify-center">
                                        <img id="logo-preview" class="h-full w-full object-cover" src="{{ asset('assets/images/app-logo.jpeg') }}" alt="Logo preview">
                                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 py-2.5 px-3"
                                    placeholder="123 Business St, City, Country"></textarea>
                            </div>
                        </div>

                        <!-- Error Display -->
                        @if(session('error'))
                            <div class="rounded-lg bg-red-50 p-4 border border-red-100 dark:bg-red-900/20 dark:border-red-800">
                                <div class="flex">
