    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 p-2">
        ...
        <div class="lg:col-span-7 order-2 lg:order-1 h-full flex flex-col">
            ...
            <textarea id="text-area" name="quotation_revision[terms_conditions]"
                ...
                placeholder="Enter terms and conditions..." rows="8">{{ $companySettings['default_terms_conditions'] ?? "* 50% Advance with Work order, rest after delivery\n* Delivery time: Supply 15-20 days After Getting PO\n* The Price included 10% VAT & 5% AIT" }}</textarea>
        </div>

        <!-- Right Column: Totals Summary -->
        <div class="lg:col-span-5 order-1 lg:order-2">
            <div
                class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-100 dark:border-gray-700 space-y-5">

                <!-- Currency Alert for Via -->
                <div x-show="quotation_revision.type === 'via' && quotation_revision.currency" x-transition
                ...
                <div class="flex justify-between items-center text-sm group">
                    ...
                    <div class="text-right">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white text-base"
                            x-text="quotation_revision.subtotal"></span>
                        <span class="text-xs text-gray-500 ml-1" x-show="quotation_revision.type === 'via'"
                            x-text="quotation_revision.currency"></span>
                        <span class="text-xs text-gray-500 ml-1" x-show="quotation_revision.type !== 'via'"
                            x-text="exchangeRateCurrency"></span>
                        ...
                        <div x-show="quotation_revision.type === 'via' && quotation_revision.currency && quotation_revision.currency !== exchangeRateCurrency"
                            ...
                            ≈ <span x-text="(quotation_revision.bdt_subtotal || 0).toFixed(2)"></span> <span
                                x-text="exchangeRateCurrency"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex gap-2 w-48 justify-end">
                        <div class="relative w-20">
                            <input type="number" step="0.01" x-model.number="quotation_revision.discount_percentage"
                                name="quotation_revision[discount_percentage]" placeholder="0"
                        ...
                        <div class="relative flex-1">
                            <input type="number" step="0.01" x-model.number="quotation_revision.discount"
                                name="quotation_revision[discount]" placeholder="0.00"
                ...
                <!-- Discounted Subtotal -->
                <div class="flex justify-between items-center text-sm pt-1" x-show="quotation_revision.discount > 0"
                    x-transition>
                    <span class="text-gray-600 dark:text-gray-400 font-medium">Discounted Subtotal</span>
                    <div class="text-right">
                        <input type="hidden" name="quotation_revision[discounted_price]"
                            x-model="quotation_revision.discounted_price">
                        <span class="font-semibold text-gray-900 dark:text-white"
                            x-text="quotation_revision.discounted_price"></span>
                    </div>
                </div>
                        ...
                        <div class="flex items-center gap-3 justify-end w-48">
                            ...
                            <div class="text-right flex-1">
                                ...
                                <span class="font-medium text-gray-700 dark:text-gray-300"
                                    x-text="quotation_revision.vat_amount"></span>
                            </div>
                        </div>
                    </div>
                </template>
                    ...
                    <div class="text-right">
                        ...
                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400 tracking-tight">
                            ...
                            <span class="text-base font-medium text-gray-500 ml-1"
                                x-show="quotation_revision.type === 'via'" x-text="quotation_revision.currency"></span>
                            <span class="text-base font-medium text-gray-500 ml-1"
                                x-show="quotation_revision.type !== 'via'" x-text="exchangeRateCurrency"></span>
                        </div>
                        <!-- BDT Equivalent for Via -->
                        <div x-show="quotation_revision.type === 'via' && quotation_revision.currency && quotation_revision.currency !== exchangeRateCurrency"
                            class="text-sm font-medium text-gray-500 mt-1">
                            ≈ <span x-text="(quotation_revision.bdt_total || 0).toFixed(2)"></span> <span
                                x-text="exchangeRateCurrency"></span>
                        </div>
                    </div>
                </div>
