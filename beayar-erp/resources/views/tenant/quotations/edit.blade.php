<x-dashboard.layout.default title="Edit Quotation">
    ...
    <div x-data="quotationForm(quotationFormConfig)">
        ...
        @include('tenant.quotations.partials.revision-history-panel')
        ...
        <div class="w-full max-w-none">
            ...
            <form id="quotation-form" x-ref="quotationForm" class="space-y-3"
                action="{{ route('tenant.quotations.update', $quotation->id) }}" method="POST"
                ...
                {{-- Action Buttons --}}
                @include('tenant.quotations.partials.action-buttons-section-edit')
...
<script>
    ...
    window.quotationFormConfig = {
        ...
        routes: {
            ...
            storeQuotation: @json(route('tenant.quotations.update', [$quotation->id]) ?? '#') // Using update route for now
        },
