    ...
    <div class="max-w-5xl mx-auto py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-8">
                <form method="POST" action="{{ route('tenant.customers.update', $customer->id) }}" id="editCustomerForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="px-8 py-6 border-b border-gray-100">
                            ...
                            <p class="text-gray-500 mt-1">Update customer details and company information.</p>
                        </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="col-span-1 md:col-span-2">
                                        ...
                                        <input type="text" name="customer_no" value="{{ old('customer_no', $customer->customer_no) }}" readonly
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="customer_name" value="{{ old('customer_name', $customer->name) }}" required placeholder="e.g. John Doe"
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="email" value="{{ old('email', $customer->email) }}" placeholder="john@example.com"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                        @error('email')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="phone" value="{{ old('phone', $customer->phone) }}" placeholder="+1 (555) 000-0000"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                        @error('phone')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="attention" value="{{ old('attention', $customer->attention) }}" placeholder="Contact Person"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                        @error('attention')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="designation" value="{{ old('designation', $customer->designation) }}" placeholder="Job Title"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                        @error('designation')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="department" value="{{ old('department', $customer->department) }}" placeholder="e.g. Sales"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all">
                                        @error('department')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="col-span-1 md:col-span-2">
                                        ...
                                        <textarea name="address" rows="3" placeholder="Full address"
                                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-black/5 focus:border-black transition-all resize-none">{{ old('address', $customer->address) }}</textarea>
                                        @error('address')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
