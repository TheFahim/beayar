                        ...
                        <div
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="group">
                                        <label for="date_format"
                                            class="block text-sm font-semibold text-gray-900 dark:text-white mb-2 flex items-center">
                            ...
                            scrollToHighlighted() {
                                this.$nextTick(() => {
                                    ...
                                    <label
                                        class="block text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
