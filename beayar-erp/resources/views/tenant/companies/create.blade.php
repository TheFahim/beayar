    ...
    <x-ui.card class="mx-auto max-w-3xl">
        <div class="p-6 border-b dark:border-gray-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Setup your new company workspace. You can invite team members later.
            </p>
        </div>

        <form action="{{ route('tenant.user-companies.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div class="col-span-2">
                     ...
                     <div class="flex items-center gap-4">
                        <div class="shrink-0">
                            <img class="h-16 w-16 object-cover rounded-full border border-gray-200 dark:border-gray-700" src="{{ asset('assets/images/app-logo.jpeg') }}" alt="Current profile photo" id="logo-preview">
                        </div>
                        <label class="block">
