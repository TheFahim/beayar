                        ...
                        <tr
                            ...
                            <td class="px-2 py-2">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="{{ route('tenant.bills.show', $item->id ?? 0) }}"
                                    ...
                                    @if(isset($latestByQuotation[$item->quotation_id]) && $latestByQuotation[$item->quotation_id] === $item->id)
                                        <a href="{{ route('tenant.bills.edit', $item->id ?? 0) }}"
                                    ...
                                    @endif
                                    @if(isset($latestByQuotation[$item->quotation_id]) && $latestByQuotation[$item->quotation_id] === $item->id)
                                        <form action="{{ route('tenant.bills.destroy', $item->id ?? 0) }}" method="POST" class="inline delete-button">
                                            @csrf
                                            @method('DELETE')
