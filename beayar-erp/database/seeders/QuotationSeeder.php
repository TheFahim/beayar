...
class QuotationSeeder extends Seeder
{
    ...
    private function seedQuotationsForCompany(UserCompany $company)
    {
        $customers = Customer::where('user_company_id', $company->id)->get();
        $products = Product::where('user_company_id', $company->id)->with('specifications')->get();
